...
import { write } from "src/converters/toZigbee";
    ...
    addManuSpecificLumiCluster: () =>
        modernExtend.deviceAddCustomCluster("manuSpecificLumi", {
            ...
            attributes: {
                ...
                dimmingRangeMaximum: {name: "dimmingRangeMaximum", ID: 0x0516, type: Zcl.DataType.UINT8, write: true}, // uint8
                effect: {name: "effect", ID: 0x051f, type: Zcl.DataType.UINT32}, // 0x23 uint32
                effectSpeed: {name: "effectSpeed", ID: 0x0520, type: Zcl.DataType.UINT8, write: true}, 
                effectColors: {name: "effectColors", ID: 0x0523, type: Zcl.DataType.OCTET_STR, write: true},
                transitionCurveCurvature: {name: "transitionCurveCurvature", ID: 0x0528, type: Zcl.DataType.SINGLE_PREC}, // 0x39 single precision float
                transitionInitialBrightness: {name: "transitionInitialBrightness", ID: 0x052c, type: Zcl.DataType.UINT8}, // uint8
                switchType: {name: "switchType", ID: 0x000a, type: Zcl.DataType.UINT8}, //  0x20 uint8

// // oops         operationMode: {name: "operationMode", ID: 0x0200, type: 0x20}, // uint8 (Decoupled/Relay)
//                 buttonLock: {name: "buttonLock", ID: 0x0200, type: 0x20}, // uint8 (Shared ID with operation_mode in some devices)
                ...
                lockRelay: {name: "lockRelay", ID: 0x0285, type: Zcl.DataType.UINT8, write: true}, // uint8
                multiClick: {name: "multiClick", ID: 0x0286, type: Zcl.DataType.UINT8, write: true}, // uint8
                clickMode: {name: "clickMode", ID: 0x0125, type: Zcl.DataType.UINT8, write: true}, // uint8

//     // Curtain / Motor Control
                motorSpeed: {name: "motorSpeed", ID: 0x0408, type: Zcl.DataType.UINT8, write: true}, // uint8
                curtainSpeed: {name: "curtainSpeed", ID: 0x043b, type: Zcl.DataType.UINT8, write: true}, // uint8
                adaptivePullingSpeed: {name: "adaptivePullingSpeed", ID: 0x0442, type: Zcl.DataType.UINT8, write: true}, // uint8
                manualStop: {name: "manualStop", ID: 0x043a, type: Zcl.DataType.BOOLEAN, write: true}, // boolean
                status: {name: "status", ID: 0x0421, type: Zcl.DataType.UINT8, write: true}, // uint8
//                 lastManualOperation: {name: "", ID: 0x0425, type: 0x20}, // uint8
//                 curtainPosition: {name: "", ID: 0x041f, type: 0x20}, // uint8
//                 traverseTime: {name: "", ID: 0x0403, type: 0x20}, // uint8
//                 calibrationStatus: {name: "", ID: 0x0426, type: 0x20}, // uint8
//                 calibrated: {name: "", ID: 0x0427, type: 0x10}, // Based on alias "curtainCalibrated" usually 0x0427
//                 identifyBeep: {name: "", ID: 0x0404, type: 0x20}, // uint8
    
//     // Power & Indicators
//                 powerOnBehavior: {name: "", ID: 0x0517, type: 0x20}, // uint8
//                 powerOutageMemory: {name: "", ID: 0x0201, type: 0x10}, // boolean
//                 overloadProtection: {name: "", ID: 0x020b, type: 0x39}, // single precision float

//  // oops        ledIndicator: {name: "ledIndicator", ID: 0x0203, type: 0x10}, // boolean
//                 ledDisabledNight: {name: "ledDisabledNight", ID: 0x0203, type: 0x10}, // boolean (Same ID as indicator)

//                 flipIndicatorLight: {name: "", ID: 0x00f0, type: 0x20}, // uint8
    
//     // Sensors (FP1E / Presence)
//                 detectionDistance: {ID: 0x010c, type: 0x20}, //detection_distance
//                 motion_sensitivity   // motion_sensitivity
//                 gas_sensitivity  // gas_sensitivity
//     // ?? air_quality: {ID: 0x010c, type: 0x20}, // Based on alias "airQuality" usually 0x010C
//                 sensitivity_adjustment: {ID: 0x010e, type: 0x20}, // uint8
//                 report_interval: {ID: 0x0110, type: 0x20}, // uint8
//                 pir_detection: {ID: 0x014d, type: 0x20}, // uint8
//                 presence: {ID: 0x0142, type: 0x20}, // uint8
//                 movement: {ID: 0x0160, type: 0x20}, // uint8
//                 target_distance: {ID: 0x015f, type: 0x23}, // uint32
//                 detection_range: {ID: 0x015b, type: 0x23}, // uint32
//                 ai_interference_source_selfidentification: {ID: 0x015e, type: 0x20}, // uint8
//                 ai_sensitivity_adaptive: {ID: 0x015d, type: 0x20}, // uint8
    ...
    lumiRGBEffect: (lookup: KeyValue, args?: Partial<modernExtend.EnumLookupArgs<"manuSpecificLumi", ManuSpecificLumi>>): ModernExtend => {
        return modernExtend.enumLookup<"manuSpecificLumi", ManuSpecificLumi>({
            ...
            lookup: lookup,
            cluster: "manuSpecificLumi",
            attribute: "effect", // {ID: 0x051f, type: 0x23},
    ...
    lumiRGBEffectSpeed: (args?: Partial<modernExtend.NumericArgs<"manuSpecificLumi", ManuSpecificLumi>>): ModernExtend => {
        return modernExtend.numeric<"manuSpecificLumi", ManuSpecificLumi>({
            name: "effect_speed",
            cluster: "manuSpecificLumi",
            attribute: "effectSpeed",  // {ID: 0x0520, type: 0x20},
            ...
            toZigbee: [
                {
                    ...
                    convertSet: async (entity, key, value, meta) => {
                        ...
                        await targetEndpoint.write<"manuSpecificLumi", ManuSpecificLumi>(
                            "manuSpecificLumi",
                            {1315: {value: packet, type: 0x41}},  // 0x0523
    ...
    lumiSwitchType: (args?: Partial<modernExtend.EnumLookupArgs<"manuSpecificLumi", ManuSpecificLumi>>) =>
        modernExtend.enumLookup<"manuSpecificLumi", ManuSpecificLumi>({
            ...
            cluster: "manuSpecificLumi",
            attribute: "switchType", // {ID: 0x000a, type: 0x20},
    ...
    lumiMotorSpeed: (args?: Partial<modernExtend.EnumLookupArgs<"manuSpecificLumi", ManuSpecificLumi>>) =>
        modernExtend.enumLookup<"manuSpecificLumi", ManuSpecificLumi>({
            ...
            cluster: "manuSpecificLumi",
            attribute: "motorSpeed", // {ID: 0x0408, type: 0x20},
    ...
    lumiCurtainSpeed: (args?: Partial<modernExtend.NumericArgs<"manuSpecificLumi", ManuSpecificLumi>>) =>
        modernExtend.numeric<"manuSpecificLumi", ManuSpecificLumi>({
            name: "curtain_speed",
            cluster: "manuSpecificLumi",
            attribute: "curtainSpeed", // {ID: 0x043b, type: 0x20},
    ...
    lumiCurtainManualStop: (args?: Partial<modernExtend.BinaryArgs<"manuSpecificLumi", ManuSpecificLumi>>) =>
        modernExtend.binary<"manuSpecificLumi", ManuSpecificLumi>({
            ...
            valueOff: ["OFF", 0],
            cluster: "manuSpecificLumi",
            attribute: "manualStop", // {ID: 0x043a, type: 0x10},
    ...
    lumiCurtainStatus: (args?: Partial<modernExtend.EnumLookupArgs<"manuSpecificLumi", ManuSpecificLumi>>) =>
        modernExtend.enumLookup<"manuSpecificLumi", ManuSpecificLumi>({
            ...
            cluster: "manuSpecificLumi",
            attribute: "status", // {ID: 0x0421, type: 0x20},
    ...
    lumiSwitchMode: (args?: Partial<modernExtend.EnumLookupArgs<"manuSpecificLumi", ManuSpecificLumi>>) =>
        modernExtend.enumLookup<"manuSpecificLumi", ManuSpecificLumi>({
            ...
            cluster: "manuSpecificLumi",
            attribute: "modeSwitch", // {ID: 0x0004, type: 0x21},
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            if (["WXKG04LM", "WXCJKG11LM", "WXCJKG12LM", "WXCJKG13LM"].includes(model.model)) {
                ...
                if (msg.data.presentValue === 0) {
                    ...
                    const timer = setTimeout(async () => publish({ action: `button_${button}_release` }), 5000);
...
export const toZigbee = {
    ...
    lumi_switch_mode_switch: {
        ...
        convertGet: async (entity, key, meta) => {
            await entity.read<"manuSpecificLumi", ManuSpecificLumi>("manuSpecificLumi", ["modeSwitch"], manufacturerOptions.lumi);
        },
    } satisfies Tz.Converter,
    ...
    lumi_switch_type: {
        ...
        convertGet: async (entity, key, meta) => {
            await entity.read<"manuSpecificLumi", ManuSpecificLumi>("manuSpecificLumi", ["switchType"], manufacturerOptions.lumi);
        },
    } satisfies Tz.Converter,
    ...
    lumi_switch_click_mode: {
        ...
        convertGet: async (entity, key, meta) => {
            if (Array.isArray(meta.mapped)) throw new Error("Not supported for groups");
            if (["ZNQBKG38LM", "ZNQBKG39LM", "ZNQBKG40LM", "ZNQBKG41LM"].includes(meta.mapped.model)) {
                await entity.read<"manuSpecificLumi", ManuSpecificLumi>("manuSpecificLumi", ["multiClick"], manufacturerOptions.lumi);
            } else {
                    ...
                    const checkState = async () => {
                        ...
                        if (result && !initialStates.includes(result["status"])) {
                            const checkDesiredState = async () => {
                                ...
                                if (result2 && desiredStates.includes(result2["status"])) {
                                    resolve();
                                } else {
...
function setTimeout(checkDesiredState: () => Promise<void>, arg1: number) {
