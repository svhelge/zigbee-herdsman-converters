...
interface EfektaMsco2Cluster {
    attributes: {
        autoBrightness: boolean;
        nightOnoffBacklight: boolean;
        nightOnBacklight: number;
        nightOffBacklight: number;
        rotate: number;
        longChartPeriod: boolean;
        longChartPeriod2: boolean;
        setAltitude: number;
    };
    commands: never;
...
interface EfektaMsIlluminanceMeasurementCluster {
    attributes: {
        autoBrightness: boolean;
        nightOnoffBacklight: boolean;
        nightOnBacklight: number;
...
interface EfektaGenLevelCtrlCluster {
    attributes: {
        nightOnoffBacklight: boolean;
        nightOnBacklight: number;
        nightOffBacklight: number;
...
interface EfektaMsTemperatureMeasurementCluster {
    attributes: {
        temperatureOffset: number;
        temperatureOffset2: number;
    };
    commands: never;
    commandResponses: never;
}

interface EfektaMsRelativeHumidityCluster {
    attributes: {
...
const efektaCluster = {
    ...
    efektaMsIlluminanceMeasurementCluster: () =>
...
const efektaExtend = {
    vocIndex: (args?: Partial<m.NumericArgs<"genAnalogInput", undefined>>) =>
        m.numeric({
            name: "voc_index",
    ...
    autoBrightnessCo2: (args?: Partial<m.BinaryArgs<"msCO2", EfektaMsco2Cluster>>) =>
        m.binary<"msCO2", EfektaMsco2Cluster>({
            name: "auto_brightness",
            valueOn: ["ON", 1],
            valueOff: ["OFF", 0],
            cluster: "msCO2",
            attribute: "autoBrightness",
            description: "Enable or Disable Auto Brightness of the Display",
            access: "STATE_SET",
            ...args,
        }),
    autoBrightnessIllum: (args?: Partial<m.BinaryArgs<"msIlluminanceMeasurement", EfektaMsIlluminanceMeasurementCluster>>) =>
        m.binary<"msIlluminanceMeasurement", EfektaMsIlluminanceMeasurementCluster>({
            name: "auto_brightness",
            valueOn: ["ON", 1],
            valueOff: ["OFF", 0],
    ...
    nightOnoffBacklightCo2: (args?: Partial<m.BinaryArgs<"msCO2", EfektaMsco2Cluster>>) =>
        m.binary<"msCO2", EfektaMsco2Cluster>({
            name: "night_onoff_backlight",
            valueOn: ["ON", 1],
            valueOff: ["OFF", 0],
            cluster: "msCO2",
            attribute: "nightOnoffBacklight",
            description: "Complete shutdown of the backlight at night mode",
            access: "STATE_SET",
            ...args,
        }),
    nightOnoffBacklightIllum: (args?: Partial<m.BinaryArgs<"EfektaMsIlluminanceMeasurementCluster", EfektaMsIlluminanceMeasurementCluster>>) =>
        m.binary<"EfektaMsIlluminanceMeasurementCluster", EfektaMsIlluminanceMeasurementCluster>({
            name: "night_onoff_backlight",
            valueOn: ["ON", 1],
            valueOff: ["OFF", 0],
            cluster: "EfektaMsIlluminanceMeasurementCluster",
            attribute: "nightOnoffBacklight",
            description: "Complete shutdown of the backlight at night mode",
            access: "STATE_SET",
            ...args,
        }),
    nightOnBacklightCo2: (args?: Partial<m.NumericArgs<"msCO2", EfektaMsco2Cluster>>) =>
        m.numeric<"msCO2", EfektaMsco2Cluster>({
            name: "night_on_backlight",
            unit: "Hr",
            valueMin: 0,
            valueMax: 23,
            cluster: "msCO2",
            attribute: "nightOnBacklight",
            description: "Night mode activation time",
            access: "STATE_SET",
            ...args,
        }),
    nightOnBacklightIllum: (args?: Partial<m.NumericArgs<"msIlluminanceMeasurement", EfektaMsIlluminanceMeasurementCluster>>) =>
        m.numeric<"msIlluminanceMeasurement", EfektaMsIlluminanceMeasurementCluster>({
            name: "night_on_backlight",
            unit: "Hr",
            valueMin: 0,
            valueMax: 23,
    ...
    nightOffBacklightCo2: (args?: Partial<m.NumericArgs<"msCO2", EfektaMsco2Cluster>>) =>
        m.numeric<"msCO2", EfektaMsco2Cluster>({
    ...
    nightOffBacklightIllum: (args?: Partial<m.NumericArgs<"msIlluminanceMeasurement", EfektaMsIlluminanceMeasurementCluster>>) =>
        m.numeric<"msIlluminanceMeasurement", EfektaMsIlluminanceMeasurementCluster>({
            name: "night_off_backlight",
            unit: "Hr",
            valueMin: 0,
    ...
    rotate: (args?: Partial<m.EnumLookupArgs<"msCO2", EfektaMsco2Cluster>>) =>
        m.enumLookup<"msCO2", EfektaMsco2Cluster>({
            name: "rotate",
    ...
    longChartPeriod: (args?: Partial<m.EnumLookupArgs<"msCO2", EfektaMsco2Cluster>>) =>
        m.enumLookup<"msCO2", EfektaMsco2Cluster>({
            name: "long_chart_period",
            lookup: {"1H": 0, "24H": 1},
            cluster: "msCO2",
            attribute: "longChartPeriod",
            description: "The period of plotting the CO2 level(OFF - 1H | ON - 24H)",
            access: "STATE_SET",
            ...args,
        }),
    longChartPeriod2: (args?: Partial<m.EnumLookupArgs<"msCO2", EfektaMsco2Cluster>>) =>
        m.enumLookup<"msCO2", EfektaMsco2Cluster>({
            name: "long_chart_period2",
            lookup: {"1H": 0, "24H": 1},
            cluster: "msCO2",
            attribute: "longChartPeriod2",
            description: "The period of plotting the VOC Index points(OFF - 1H | ON - 24H)",
            access: "STATE_SET",
            ...args,
        }),
    setAltitude: (args?: Partial<m.NumericArgs<"msCO2", EfektaMsco2Cluster>>) =>
        m.numeric<"msCO2", EfektaMsco2Cluster>({
            name: "set_altitude",
            unit: "meters",
            valueMin: 0,
            valueMax: 3000,
            cluster: "msCO2",
            attribute: "setAltitude",
            description: "Setting the altitude above sea level (for high accuracy of the CO2 sensor)",
            access: "STATE_SET",
            ...args,
        }),
    temperatureOffset: (args?: Partial<m.NumericArgs<"msTemperatureMeasurement", EfektaMsTemperatureMeasurementCluster>>) =>
        m.numeric<"msTemperatureMeasurement", EfektaMsTemperatureMeasurementCluster>({
    ...
    temperatureOffset2: (args?: Partial<m.NumericArgs<"msTemperatureMeasurement", EfektaMsTemperatureMeasurementCluster>>) =>
        m.numeric<"msTemperatureMeasurement", EfektaMsTemperatureMeasurementCluster>({
            name: "temperature_offset",
            unit: "°C",
            valueMin: -50,
            ...
            scale: 10,
            cluster: "msTemperatureMeasurement",
            attribute: "temperatureOffset2",
            description: "Adjust temperature",
            access: "STATE_SET",
            ...args,
        }),
    humidityOffset: (args?: Partial<m.NumericArgs<"msRelativeHumidity", EfektaMsRelativeHumidityCluster>>) =>
        m.numeric<"msRelativeHumidity", EfektaMsRelativeHumidityCluster>({
...
export const definitions: DefinitionWithExtend[] = [
    {
        ...
        extend: [
            ...
            efektaExtend.autoBrightnessCo2(),
            efektaExtend.nightOnoffBacklightCo2(),
            efektaExtend.nightOnBacklightCo2(),
            efektaExtend.nightOffBacklightCo2(),
            efektaExtend.rotate(),
            efektaExtend.longChartPeriod(),
            m.enumLookup({
                name: "long_chart_period2",
                lookup: {"1H": 0, "24H": 1},
                cluster: "msCO2",
                attribute: {ID: 0x0404, type: Zcl.DataType.BOOLEAN}, // Correct?? ID: 0x0244 is also used for long_chart_period2
                description: "The period of plotting the VOC Index points(OFF - 1H | ON - 24H)",
                access: "STATE_SET",
            }),
            efektaExtend.setAltitude(),
            efektaExtend.temperatureOffset(),
            efektaExtend.humidityOffset(),
            m.enumLookup({
    ...
    },
    {
        ...
        description: "CO2 Monitor with IPS TFT Display, outdoor temperature and humidity, date and time",
        extend: [
            efektaCluster.efektaMsco2Cluster(),
            m.deviceEndpoints({endpoints: {"1": 1, "2": 2}}),
            m.co2({
                reporting: co2Reporting,
                access: "STATE",
    ...
    },
    {
        ...
        extend: [
            ...
            efektaExtend.setAltitude(),
            efektaExtend.temperatureOffset2(),
            efektaExtend.humidityOffset(),
            m.binary({
                name: "automatic_calibrations",
                valueOn: ["ON", 1],
    ...
    },
    {
        ...
        extend: [
            ...
            efektaExtend.autoBrightnessIllum(),
            efektaExtend.nightOnoffBacklightIllum(),
            efektaExtend.nightOnBacklightIllum(),
    ...
    },
    {
        ...
        extend: [
            ...
            efektaExtend.nightOnoffBacklightIllum(),
            efektaExtend.nightOnBacklightIllum(),
            efektaExtend.nightOffBacklightIllum(),
            efektaExtend.longChartPeriod(),
            efektaExtend.longChartPeriod2({
                description: "The period of plotting the VOC Index points(OFF - 1H | ON - 24H)",
            }),
            m.enumLookup({
                name: "internal_or_external",
    ...
    },
    {
        ...
        extend: [
            ...
            m.numeric({
                ...
                valueMax: 23,
                cluster: "msCO2",
                attribute: {ID: 0x0403, type: Zcl.DataType.UINT8}, // Correct?? name: "nightOffBacklight", ID: 0x0406
                description: "Night mode deactivation time",
                access: "STATE_SET",
            }),
            efektaExtend.longChartPeriod(),
    ...
    },
    {
        ...
        extend: [
            ...
            m.binary<"genLevelCtrl", EfektaGenLevelCtrlCluster>({
                name: "night_onoff_backlight",
                valueOn: ["ON", 1],
                valueOff: ["OFF", 0],
    ...
    },
    {
        ...
        extend: [
            efektaCluster.efektaMsco2Cluster(),
            efektaCluster.efektaMsIlluminanceMeasurementCluster(),
            m.co2({
                reporting: false,
                access: "STATE",
            }),
