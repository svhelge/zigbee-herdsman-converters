...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            await endpoint.read<"manuSpecificLumi", ManuSpecificLumi>("manuSpecificLumi", ["effect"]);
            await endpoint.read<"manuSpecificLumi", ManuSpecificLumi>("manuSpecificLumi", ["effectSpeed"]);
            await endpoint.read<"manuSpecificLumi", ManuSpecificLumi>("manuSpecificLumi", ["effectColors"]);
    ...
    },
    {
        ...
        extend: [
            ...
            lumi.modernExtend.lumiDimmingRangeMin({
                name: "min_brightness",
                description: "Minimum brightness level",
            }),
            lumi.modernExtend.lumiDimmingRangeMax({
                name: "max_brightness",
    ...
    },
    {
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            // turn on the "multiple clicks" mode, otherwise the only "single click" events.
            // if value is 1 - there will be single clicks, 2 - multiple.
            await endpoint1.write<"manuSpecificLumi", ManuSpecificLumi>("manuSpecificLumi", {clickMode: {value: 0x02}}, {manufacturerCode: lumi.manufacturerCode});
            await reporting.bind(endpoint1, coordinatorEndpoint, ["genOnOff", "genPowerCfg"]);
        },
    },
    {
